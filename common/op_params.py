...
class opParams:
  def __init__(self):
    ...
    self.default_params = {'steerRatio': {'default': 16.33, 'allowed_types': [float], 'description': 'Base steering ratio used in the MPC', 'live': True},
                           'srBoost': {'default': 0.0, 'allowed_types': [float], 'description': 'Value to boost the base steering ratio', 'live': True},
